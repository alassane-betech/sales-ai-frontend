...
export function Testimonials() {
  ...
  const testimonials = [
    {
      quote: "SalesAI transformed our demo booking process. We're now booking 3x more meetings with qualified leads.",
      author: "Sarah Chen",
      role: "VP of Sales",
    ...
    {
      quote: "The WhatsApp automation is incredible. Our consultants can focus on high-value conversations while AI handles the rest.",
    ...
    {
      quote: "Meeting intelligence feature saves us hours every week. The AI summaries are spot-on and actionable.",
      author: "Emily Watson",
      role: "Sales Director",
    ...
    {
      quote: "The integration with our existing tools was seamless. ROI was visible within the first month.",
      author: "David Kim",
      role: "Head of Growth",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {[
            ...
            {
              title: "Agencies",
              description: "Scale outreach and manage multiple client campaigns",
              gradient: "from-neon-purple to-pink-500"
            }
          ].map((useCase, index) => (
            <div key={useCase.title} className="text-center">
              <div className={`w-16 h-16 bg-gradient-to-r ${useCase.gradient} rounded-2xl flex items-center justify-center mx-auto mb-4`}>
                <span className="text-white font-bold text-xl">{useCase.title[0]}</span>
              </div>
